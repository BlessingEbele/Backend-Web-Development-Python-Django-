...
print(f"The interserction of the first age and the second age:{age.intersection (age2)}")
print(f"The intersection of the first name and the second name:{names.intersection(names2)}")
